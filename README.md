...
## 🔹 Project Overview  
A powerful Python-based **Multi-Mode Calculator** with multiple functionalities, including:  
- **Basic Arithmetic** (Addition, Subtraction, Multiplication, Division)  
- **Advanced Mathematics** (Trigonometry, Logarithms, Exponentials, Power functions)  
- **Graphing Mode** (Plots for quadratic, sine, and cosine functions)  
- **Unit Converter** (Kilometers ↔ Miles, Celsius ↔ Fahrenheit, Kilograms ↔ Pounds)  

This is **Day 4** of my **#30DaysOfPython** challenge.

---

## 🚀 Features  
✅ **Basic Calculator** – Performs fundamental arithmetic operations  
✅ **Advanced Calculator** – Includes trigonometric, logarithmic, and power functions  
✅ **Graphing Mode** – Visualizes mathematical functions with **Matplotlib**  
✅ **Unit Converter** – Converts common measurement units  
